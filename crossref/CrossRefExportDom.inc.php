...
/**
	 ...
	 * @return XMLNode
	 */
	function &generateJournalReportDom(&$doc, &$journal, &$issue, &$section, &$article) {
		// Create the base node
		$journalArticleNode =& XMLCustomWriter::createElement($doc, 'report-paper_metadata');
		//XMLCustomWriter::setAttribute($journalArticleNode, 'language', $article->getLocalizedType());
