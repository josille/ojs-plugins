...
<div>Select an export format:</div>
<input type="radio" name="type_articles" id="type_article" value='article' checked="checked">Article<br/>
<input type="radio" name="type_articles" id="type_report" value='report'>Report (journal with no ISSN)<br/><br/>
