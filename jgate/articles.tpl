 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.jgate.export.selectArticle"}
{assign var="pageCrumbTitle" value="plugins.importexport.jgate.export.selectArticle"}
